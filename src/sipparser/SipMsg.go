...
const (
	...
	SIP_MSG_COMMON_HDR_P_ASSERTED_IDENTITY = 18
...
var g_SipMsgHeaderIndexToCommonIndex = [SIP_HDR_MAX_NUM]int{
	...
	SIP_HDR_P_ASSERTED_IDENTITY: SIP_MSG_COMMON_HDR_P_ASSERTED_IDENTITY,
}
...
var g_SipMsgCommonIndexToHeaderIndex = [SIP_MSG_COMMON_HDR_MAX_NUM]SipHeaderIndexType{
	...
	SIP_MSG_COMMON_HDR_P_ASSERTED_IDENTITY: SIP_HDR_P_ASSERTED_IDENTITY,
}
