...
const (
	ABNF_CHARSET_DIGIT               = 0
	ABNF_CHARSET_ALPHA               = 0
	ABNF_CHARSET_LOWER               = 0
	ABNF_CHARSET_UPPER               = 0
	ABNF_CHARSET_ALPHANUM            = 0
	ABNF_CHARSET_LOWER_HEX_ALPHA     = 0
	ABNF_CHARSET_UPPER_HEX_ALPHA     = 0
	ABNF_CHARSET_LOWER_HEX           = 0
	ABNF_CHARSET_UPPER_HEX           = 0
	ABNF_CHARSET_HEX                 = 0
	ABNF_CHARSET_CRLF_CHAR           = 0
	ABNF_CHARSET_WSP_CHAR            = 0
	ABNF_CHARSET_LWS_CHAR            = 0
	ABNF_CHARSET_UTF8_CHAR           = 0
	ABNF_CHARSET_HOSTNAME            = 0
	ABNF_CHARSET_URI_UNRESERVED      = 0
	ABNF_CHARSET_URI_RESERVED        = 0
	ABNF_CHARSET_URI_SCHEME          = 0
	ABNF_CHARSET_URI_URIC            = 0
	ABNF_CHARSET_URI_URIC_NO_SLASH   = 0
	ABNF_CHARSET_URI_PCHAR           = 0
	ABNF_CHARSET_URI_REG_NAME        = 0
	ABNF_CHARSET_SIP_TOKEN           = 0
	ABNF_CHARSET_SIP_SEPARATORS      = 0
	ABNF_CHARSET_SIP_WORD            = 0
	ABNF_CHARSET_SIP_QUOTED_PAIR     = 0
	ABNF_CHARSET_SIP_QUOTED_TEXT     = 0
	ABNF_CHARSET_SIP_COMMENT         = 0
	ABNF_CHARSET_SIP_USER            = 0
	ABNF_CHARSET_SIP_PASSWORD        = 0
	ABNF_CHARSET_SIP_PNAME           = 0
	ABNF_CHARSET_SIP_PVALUE          = 0
	ABNF_CHARSET_SIP_HNAME           = 1
	ABNF_CHARSET_SIP_HVALUE          = 1
	ABNF_CHARSET_SIP_REASON_PHRASE   = 1
	ABNF_CHARSET_TEL_PHONE_DIGIT     = 1
	ABNF_CHARSET_TEL_PHONE_DIGIT_HEX = 1
	ABNF_CHARSET_TEL_PNAME           = 1
	ABNF_CHARSET_TEL_PVALUE          = 1
	ABNF_CHARSET_TEL_VISUAL_SPERATOR = 1
)

const (
	ABNF_CHARSET_MASK_DIGIT               uint32 = (0x00000001)
	ABNF_CHARSET_MASK_ALPHA               uint32 = (0x00000002)
	ABNF_CHARSET_MASK_LOWER               uint32 = (0x00000004)
	ABNF_CHARSET_MASK_UPPER               uint32 = (0x00000008)
	ABNF_CHARSET_MASK_ALPHANUM            uint32 = (0x00000010)
	ABNF_CHARSET_MASK_LOWER_HEX_ALPHA     uint32 = (0x00000020)
	ABNF_CHARSET_MASK_UPPER_HEX_ALPHA     uint32 = (0x00000040)
	ABNF_CHARSET_MASK_LOWER_HEX           uint32 = (0x00000080)
	ABNF_CHARSET_MASK_UPPER_HEX           uint32 = (0x00000100)
	ABNF_CHARSET_MASK_HEX                 uint32 = (0x00000200)
	ABNF_CHARSET_MASK_CRLF_CHAR           uint32 = (0x00000400)
	ABNF_CHARSET_MASK_WSP_CHAR            uint32 = (0x00000800)
	ABNF_CHARSET_MASK_LWS_CHAR            uint32 = (0x00001000)
	ABNF_CHARSET_MASK_UTF8_CHAR           uint32 = (0x00002000)
	ABNF_CHARSET_MASK_HOSTNAME            uint32 = (0x00004000)
	ABNF_CHARSET_MASK_URI_UNRESERVED      uint32 = (0x00008000)
	ABNF_CHARSET_MASK_URI_RESERVED        uint32 = (0x00010000)
	ABNF_CHARSET_MASK_URI_SCHEME          uint32 = (0x00020000)
	ABNF_CHARSET_MASK_URI_URIC            uint32 = (0x00040000)
	ABNF_CHARSET_MASK_URI_URIC_NO_SLASH   uint32 = (0x00080000)
	ABNF_CHARSET_MASK_URI_PCHAR           uint32 = (0x00100000)
	ABNF_CHARSET_MASK_URI_REG_NAME        uint32 = (0x00200000)
	ABNF_CHARSET_MASK_SIP_TOKEN           uint32 = (0x00400000)
	ABNF_CHARSET_MASK_SIP_SEPARATORS      uint32 = (0x00800000)
	ABNF_CHARSET_MASK_SIP_WORD            uint32 = (0x01000000)
	ABNF_CHARSET_MASK_SIP_QUOTED_PAIR     uint32 = (0x02000000)
	ABNF_CHARSET_MASK_SIP_QUOTED_TEXT     uint32 = (0x04000000)
	ABNF_CHARSET_MASK_SIP_COMMENT         uint32 = (0x08000000)
	ABNF_CHARSET_MASK_SIP_USER            uint32 = (0x10000000)
	ABNF_CHARSET_MASK_SIP_PASSWORD        uint32 = (0x20000000)
	ABNF_CHARSET_MASK_SIP_PNAME           uint32 = (0x40000000)
	ABNF_CHARSET_MASK_SIP_PVALUE          uint32 = (0x80000000)
	ABNF_CHARSET_MASK_SIP_HNAME           uint32 = (0x00000001)
	ABNF_CHARSET_MASK_SIP_HVALUE          uint32 = (0x00000002)
	ABNF_CHARSET_MASK_SIP_REASON_PHRASE   uint32 = (0x00000004)
	ABNF_CHARSET_MASK_TEL_PHONE_DIGIT     uint32 = (0x00000008)
	ABNF_CHARSET_MASK_TEL_PHONE_DIGIT_HEX uint32 = (0x00000010)
	ABNF_CHARSET_MASK_TEL_PNAME           uint32 = (0x00000020)
	ABNF_CHARSET_MASK_TEL_PVALUE          uint32 = (0x00000040)
	ABNF_CHARSET_MASK_TEL_VISUAL_SPERATOR uint32 = (0x00000080)
)

func IsDigit(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_DIGIT) != 0
}

func IsAlpha(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_ALPHA) != 0
}

func IsLower(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_LOWER) != 0
}

func IsUpper(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_UPPER) != 0
}

func IsAlphanum(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_ALPHANUM) != 0
}

func IsLowerHexAlpha(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_LOWER_HEX_ALPHA) != 0
}

func IsUpperHexAlpha(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_UPPER_HEX_ALPHA) != 0
}

func IsLowerHex(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_LOWER_HEX) != 0
}

func IsUpperHex(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_UPPER_HEX) != 0
}

func IsHex(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_HEX) != 0
}

func IsCrlfChar(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_CRLF_CHAR) != 0
}

func IsWspChar(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_WSP_CHAR) != 0
}

func IsLwsChar(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_LWS_CHAR) != 0
}

func IsUtf8Char(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_UTF8_CHAR) != 0
}

func IsHostname(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_HOSTNAME) != 0
}

func IsUriUnreserved(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_URI_UNRESERVED) != 0
}

func IsUriReserved(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_URI_RESERVED) != 0
}

func IsUriScheme(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_URI_SCHEME) != 0
}

func IsUriUric(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_URI_URIC) != 0
}
func IsUriUricNoSlash(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_URI_URIC_NO_SLASH) != 0
}

func IsUriPchar(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_URI_PCHAR) != 0
}

func IsUriRegName(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_URI_REG_NAME) != 0
}

func IsSipToken(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_SIP_TOKEN) != 0
}
func IsSipSeparators(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_SIP_SEPARATORS) != 0
}
func IsSipWord(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_SIP_WORD) != 0
}

func IsSipQuotedPair(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_SIP_QUOTED_PAIR) != 0
}

func IsSipQuotedText(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_SIP_QUOTED_TEXT) != 0
}

func IsSipComment(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_SIP_COMMENT) != 0
}

func IsSipUser(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_SIP_USER) != 0
}

func IsSipPassword(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_SIP_PASSWORD) != 0
}

func IsSipPname(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_SIP_PNAME) != 0
}

func IsSipPvalue(ch byte) bool {
	return (g_charsets[0][ch] & ABNF_CHARSET_MASK_SIP_PVALUE) != 0
}

func IsSipHname(ch byte) bool {
	return (g_charsets[1][ch] & ABNF_CHARSET_MASK_SIP_HNAME) != 0
}

func IsSipHvalue(ch byte) bool {
	return (g_charsets[1][ch] & ABNF_CHARSET_MASK_SIP_HVALUE) != 0
}

func IsSipReasonPhrase(ch byte) bool {
	return (g_charsets[1][ch] & ABNF_CHARSET_MASK_SIP_REASON_PHRASE) != 0
}

func IsTelPhoneDigit(ch byte) bool {
	return (g_charsets[1][ch] & ABNF_CHARSET_MASK_TEL_PHONE_DIGIT) != 0
}

func IsTelPhoneDigitHex(ch byte) bool {
	return (g_charsets[1][ch] & ABNF_CHARSET_MASK_TEL_PHONE_DIGIT_HEX) != 0
}

func IsTelPname(ch byte) bool {
	return (g_charsets[1][ch] & ABNF_CHARSET_MASK_TEL_PNAME) != 0
}

func IsTelPvalue(ch byte) bool {
	return (g_charsets[1][ch] & ABNF_CHARSET_MASK_TEL_PVALUE) != 0
}

func IsTelVisualSperator(ch byte) bool {
	return (g_charsets[1][ch] & ABNF_CHARSET_MASK_TEL_VISUAL_SPERATOR) != 0
}
